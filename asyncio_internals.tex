    ...
    \begin{algorithm}[H]
        ...
        \Fn{\upshape \lstinline{_run_once()}}{
            ...
            \begin{cases}
                ...
                \text{minimal timeout}, & \text{if \colorbox{Lavender}{scheduled} is not empty} \\
...
\]
            ...
            \;
            \colorbox{SkyBlue}{Handle queue} \lstinline{+=} handles from \colorbox{Lavender}{scheduled} which the time is up \\
            \;
