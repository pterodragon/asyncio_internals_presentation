...
\node[below=of futcbbox] (phan) {\&loop};
\node[draw, fit=(futcbbox.west |- phan.center) (futcbbox.east |- phan.center), inner xsep=0pt, inner ysep = 10pt] (loopbox) {};
\node[fill=white] (futcblabel) at (futcbbox.north west) {callbacks};
\node[draw, dotted, fit=(futcbarr) (futcblabel) (loopbox), inner sep=10pt] (futbox) {};
